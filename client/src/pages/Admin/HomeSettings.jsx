  ...
  return (
    <div className="min-h-screen bg-surface-50 dark:bg-surface-900 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-surface-900 dark:text-white">Personalizar Home</h1>
        ...
        <div className="bg-white dark:bg-surface-800 rounded-lg shadow mb-6">
          ...
          <div className="p-6">
            ...
            {activeTab === 'carousel' && (
              <div>
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <h2 className="text-xl font-semibold text-surface-900 dark:text-white">Carrousel Principal</h2>
                ...
                <div className="space-y-6">
                  {settings.carousel.map((slide, index) => (
                    <div key={index} className="border border-surface-200 dark:border-surface-700 rounded-lg p-6 bg-surface-50 dark:bg-surface-900 dark:bg-surface-700">
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          <div className="relative aspect-[16/5] bg-surface-200 rounded-lg overflow-hidden">
                            {slide.image ? (
                              <img
                                src={slide.image}
                                alt={`Slide ${index + 1}`}
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="flex items-center">
                            ...
                            />
                            <label htmlFor={`enabled-${index}`} className="ml-2 text-sm text-surface-700 dark:text-surface-300">
                              Slide activo
                            </label>
                          </div>
                        </div>
                  ...
                  {settings.carousel.length === 0 && (
                    <div className="text-center py-12 bg-surface-50 dark:bg-surface-900 rounded-lg border-2 border-dashed border-surface-300 dark:border-surface-600">
            ...
            {activeTab === 'hero' && (
              <div className="space-y-6">
                <div>
                  <h2 className="text-xl font-semibold text-surface-900 dark:text-white mb-4">Hero Section</h2>
                ...
                <div className="grid grid-cols-1 gap-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <h3 className="font-medium text-surface-900 dark:text-white">Botón Principal</h3>
                      <div>
                        <label className="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-1">
                          Texto
                        </label>
                    ...
                    <div className="space-y-4">
                      <h3 className="font-medium text-surface-900 dark:text-white">Botón Secundario</h3>
                      <div>
                        <label className="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-1">
                          Texto
                        </label>
            ...
            {activeTab === 'features' && (
              <div className="space-y-6">
                <div>
                  <h2 className="text-xl font-semibold text-surface-900 dark:text-white mb-2">Características</h2>
                ...
                <div className="flex items-center mb-4">
                  <input
                    ...
                    className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-surface-300 dark:border-surface-600 rounded"
                  />
                  <label htmlFor="features-enabled" className="ml-2 text-sm font-medium text-surface-700 dark:text-surface-300">
                  ...
                  <>
                    ...
                    <div className="space-y-4">
                      {settings.features.map((feature, index) => {
                        ...
                        return (
                          <div key={index} className="border border-surface-200 dark:border-surface-700 rounded-lg p-4 bg-surface-50 dark:bg-surface-900 dark:bg-surface-800">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                              <div>
                                ...
                                <div className="flex items-center gap-2">
                                  <div className="flex-shrink-0 w-10 h-10 bg-primary-100 dark:bg-primary-900 rounded flex items-center justify-center">
            ...
            {activeTab === 'coupons' && (
              <div className="space-y-6">
                <div>
                  <h2 className="text-xl font-semibold text-surface-900 dark:text-white mb-2">Banner de Cupones</h2>
                  <p className="text-sm text-surface-600 dark:text-surface-400">
                ...
                <div className="bg-primary-50 dark:bg-primary-950/30 border border-primary-200 dark:border-primary-800 rounded-lg p-4">
                  <div className="flex items-start">
                    <TagIcon className="h-5 w-5 text-primary-600 mt-0.5 mr-2" />
                    <div>
                ...
                <div className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-surface-300 dark:border-surface-600 rounded"
                  />
                  <label htmlFor="coupon-banner-enabled" className="ml-2 text-sm font-medium text-surface-700 dark:text-surface-300">
            ...
            {activeTab === 'sections' && (
              <div className="space-y-8">
                <div>
                  <h2 className="text-xl font-semibold text-surface-900 dark:text-white mb-4">Secciones Adicionales</h2>
                </div>
                ...
                <div className="border-b border-surface-200 dark:border-surface-700 pb-6">
                  <div className="flex items-center mb-4">
                    <input
                      ...
                      className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-surface-300 dark:border-surface-600 rounded"
                    />
                    <label htmlFor="categories-enabled" className="ml-2 text-sm font-medium text-surface-700 dark:text-surface-300">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        {allCategories.length === 0 ? (
                          <div className="text-sm text-surface-500 dark:text-surface-400 italic p-4 bg-surface-50 dark:bg-surface-900 dark:bg-surface-800 rounded-lg">
                ...
                <div>
                  <div className="flex items-center mb-4">
                    <input
                      ...
                      className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-surface-300 dark:border-surface-600 rounded"
                    />
                    <label htmlFor="newsletter-enabled" className="ml-2 text-sm font-medium text-surface-700 dark:text-surface-300">
                ...
                <div className="border-t border-surface-200 dark:border-surface-700 pt-8">
                  <h3 className="text-lg font-semibold text-surface-900 dark:text-white mb-6">Secciones Personalizables</h3>
                        ...
                        <div key={section.id} className="border border-surface-300 dark:border-surface-600 rounded-lg p-6 bg-white dark:bg-surface-800 shadow-sm">
                          <div className="flex items-start justify-between mb-4">
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                <h4 className="text-md font-semibold text-surface-900 dark:text-white">Sección #{index + 1}</h4>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            <div>
                              <label className="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-1">Subtítulo</label>
                              <input
                                type="text"
                            ...
                            <div>
                              <label className="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-1">Icono</label>
                              <select
                                value={section.icon}
                            ...
                            <div>
                              <label className="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-1">Color de Fondo</label>
                              <div className="flex items-center space-x-2">
                                <input
                                  type="color"
                                  value={section.backgroundColor}
                                  onChange={(e) => handleUpdateCustomSection(section.id, 'backgroundColor', e.target.value)}
                                  className="h-10 w-20 border border-surface-300 dark:border-surface-600 rounded cursor-pointer"
                                />
                                <input
                                  type="text"
                                  value={section.backgroundColor}
                            ...
                            <div>
                              <label className="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-1">Color de Texto/Icono</label>
                              <div className="flex items-center space-x-2">
                                <input
                                  type="color"
                            ...
                            <div>
                              <label className="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-1">Texto del Botón</label>
                              <input
                                type="text"
                            ...
                            <div>
                              <label className="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-1">Enlace del Botón</label>
                              <input
                                type="text"
                            ...
                            <div>
                              <label className="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-1">Orden</label>
                              <input
                                type="number"
                          ...
                          {/* Preview */}
                          <div className="mt-6 p-4 border-2 border-dashed border-surface-300 dark:border-surface-600 rounded-lg bg-surface-50 dark:bg-surface-900">
                            <p className="text-xs text-surface-500 dark:text-surface-400 mb-3">Vista Previa:</p>
                            <div
                  ...
                  <div className="border-2 border-dashed border-surface-300 dark:border-surface-600 rounded-lg p-6 bg-surface-50 dark:bg-surface-900 dark:bg-surface-800">
                    <h4 className="text-md font-semibold text-surface-900 dark:text-white mb-4 flex items-center">
            ...
            {activeTab === 'appearance' && (
              <div className="space-y-6">
                <div>
                  <h2 className="text-xl font-semibold text-surface-900 dark:text-white mb-4">Logo de la Tienda</h2>
                  <p className="text-sm text-surface-600 dark:text-surface-400 mb-6">
                ...
                {logoPreview && (
                  <div>
                    ...
                    <div className="border-2 border-dashed border-surface-300 dark:border-surface-600 rounded-lg p-6 bg-surface-50 dark:bg-surface-900">
                      <img 
                        src={logoPreview} 
                        alt="Logo preview" 
                ...
                {/* Divider */}
                <div className="border-t border-surface-200 dark:border-surface-700 my-8"></div>

                {/* Favicon Section */}
                <div>
                  <h2 className="text-xl font-semibold text-surface-900 dark:text-white mb-4">Favicon</h2>
                  <p className="text-sm text-surface-600 dark:text-surface-400 mb-6">
                ...
                {faviconPreview && (
                  <div>
                    ...
                    <div className="border-2 border-dashed border-surface-300 dark:border-surface-600 rounded-lg p-6 bg-surface-50 dark:bg-surface-900 flex items-center">
                      <img 
                        src={faviconPreview} 
                        alt="Favicon preview" 
                      ...
                      />
                      <span className="text-sm text-surface-600 dark:text-surface-400">Favicon actual (32x32px)</span>
                    </div>
                  </div>
                )}
            ...
            {activeTab === 'footer' && (
              <div className="space-y-8">
                <div>
                  <h2 className="text-xl font-semibold text-surface-900 dark:text-white mb-2">Configuración del Footer</h2>
                  <p className="text-sm text-surface-600 dark:text-surface-400 mb-6">
                ...
                <div className="flex items-center justify-between p-4 bg-surface-50 dark:bg-surface-900 rounded-lg">
                  <div>
                    <h3 className="text-sm font-medium text-surface-900 dark:text-white">Mostrar Footer</h3>
                    <p className="text-xs text-surface-500 dark:text-surface-400 mt-1">Activar o desactivar el pie de página</p>
                  </div>
                ...
                <div className="border-t border-surface-200 dark:border-surface-700 pt-6">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-semibold text-surface-900 dark:text-white">Información de Contacto</h3>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        type="checkbox"
                ...
                <div className="border-t border-surface-200 dark:border-surface-700 pt-6">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-semibold text-surface-900 dark:text-white">Redes Sociales</h3>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        type="checkbox"
                ...
                <div className="border-t border-surface-200 dark:border-surface-700 pt-6">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-semibold text-surface-900 dark:text-white">Columnas de Enlaces</h3>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        type="checkbox"
                  ...
                  {/* Column 1 */}
                  <div className="mb-6 p-4 bg-surface-50 dark:bg-surface-900 rounded-lg">
                    <h4 className="text-sm font-semibold text-surface-900 dark:text-white mb-3">Columna 1</h4>
                    <div className="space-y-3">
                      <div>
                        <label className="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-2">
                          Título
                  ...
                  {/* Column 2 */}
                  <div className="mb-6 p-4 bg-surface-50 dark:bg-surface-900 rounded-lg">
                    <h4 className="text-sm font-semibold text-surface-900 dark:text-white mb-3">Columna 2</h4>
                    <div className="space-y-3">
                      <div>
                        <label className="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-2">
                          Título
                  ...
                  {/* Column 3 */}
                  <div className="mb-6 p-4 bg-surface-50 dark:bg-surface-900 rounded-lg">
                    <h4 className="text-sm font-semibold text-surface-900 dark:text-white mb-3">Columna 3</h4>
                    <div className="space-y-3">
                      <div>
                        <label className="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-2">
                          Título
                ...
                {/* Footer Bottom */}
                <div className="border-t border-surface-200 dark:border-surface-700 pt-6">
                  <h3 className="text-lg font-semibold text-surface-900 dark:text-white mb-4">Pie de Página (Bottom)</h3>
                  <div className="space-y-4">
                    <div>
                      <label className="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-2">
                        Texto de Copyright
                    ...
                    <div className="flex items-center justify-between p-4 bg-surface-50 dark:bg-surface-900 rounded-lg">
                      <div>
                        <h4 className="text-sm font-medium text-surface-900 dark:text-white">Mostrar Métodos de Pago</h4>
                        <p className="text-xs text-surface-500 dark:text-surface-400 mt-1">Iconos de tarjetas y formas de pago</p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input
                          type="checkbox"
            ...
            {activeTab === 'seo' && (
              <div className="space-y-6">
                <div>
                  <h2 className="text-xl font-semibold text-surface-900 dark:text-white mb-2">Metadatos SEO</h2>
                  <p className="text-sm text-surface-600 dark:text-surface-400 mb-6">
                ...
                {/* Preview */}
                <div className="border-t border-surface-200 dark:border-surface-700 pt-6">
                  <h3 className="text-sm font-medium text-surface-900 dark:text-white mb-4">Vista Previa en Google</h3>
                  <div className="bg-white dark:bg-surface-800 border border-surface-200 dark:border-surface-700 rounded-lg p-4">
                    <div className="text-sm text-primary-700 mb-1">{settings.metaTitle || 'Título de la página'}</div>
                    <div className="text-xs text-green-700 mb-2">https://tutienda.com</div>
                    <div className="text-sm text-surface-600 dark:text-surface-400">{settings.metaDescription || 'Descripción de la página'}</div>
                  </div>
                </div>
        ...
        <div className="flex items-center justify-between bg-white dark:bg-surface-800 rounded-lg shadow p-6">
          <a
            ...
            className="inline-flex items-center px-4 py-2 border border-surface-300 dark:border-surface-600 text-surface-700 dark:text-surface-300 rounded-lg hover:bg-surface-50 dark:bg-surface-900 transition-colors"
          >
